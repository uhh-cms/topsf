...
from topsf.util import has_tag, IF_MC
...
def topsf_selection_hists(
    ...
    **kwargs,
    ...
    if not has_tag("skip_btag_weights", self.config_inst, self.dataset_inst, operator=any):
        event_masks["selected_no_bjet"] = results.steps.all_but_bjet
...
@topsf_selection_hists.setup
def topsf_selection_hists_setup(
...
@topsf_selection_hists.init
def topsf_selection_hists_init(self: Selector) -> None:
